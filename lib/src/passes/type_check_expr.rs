...
use crate::{
    ...
    typ::{InfoTypeError, Instantiator},
};

#[derive(Debug)]
pub struct Scope<'a> {
    scopes: Vec<Cow<'a, HashMap<String, InfoTypeExpr>>>,
}

impl<'a> Scope<'a> {
    pub fn new(global_scope: HashMap<String, InfoTypeExpr>) -> Self {
        Self {
    ...
    pub fn get(&self, name: &str) -> Option<InfoTypeExpr> {
    ...
    pub fn insert(&mut self, name: String, typ: InfoTypeExpr) {
