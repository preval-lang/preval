...
pub fn infer_expr_type(
    ...
    match &expr.expr {
        ...
        Expr::InitializeStruct(struct_type, fields) => {
            let def_fields = if let Type::Struct(def_fields, generics, _) =
                resolve(struct_type, module, expr.idx)?
            {
                def_fields
            } else {
        ...
        Expr::Access(struct_expr, field_name) => {
            ...
            if let Type::Struct(fields, generics, _) = resolve(&struct_type, module, expr.idx)? {
